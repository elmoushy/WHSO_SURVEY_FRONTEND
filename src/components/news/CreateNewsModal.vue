...
const modalTitle = computed(() => 
  props.newsType === 'SLIDER' ? 'Create New Slider' : 'Create New News'
)
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const createFn = props.newsType === 'SLIDER' ? createSliderNews : createNormalNews
    ...
    if (!response.data?.id) {
      throw new Error('Failed to get news ID from response')
    }
    ...
    if (imageFile.value) {
      const uploadFn = props.newsType === 'SLIDER' ? uploadSliderImage : uploadNormalImage
    ...
    error.value = err.response?.data?.detail || 'Failed to create news. Please try again.'
  } finally {
        ...
        <div :class="$style.modal">
          ...
          <div :class="$style.content">
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <!-- Image Upload -->
              <div :class="$style.formGroup">
                <label :class="$style.label">Image (Optional)</label>
                ...
                <div v-else :class="$style.uploadArea">
                  ...
                  <label for="imageUpload" :class="$style.uploadLabel">
                    ...
                    <span :class="$style.uploadText">Click to upload image</span>
          ...
          <div :class="$style.footer">
            ...
            >
              <span v-if="!isSubmitting">Create {{ newsType === 'SLIDER' ? 'Slider' : 'News' }}</span>
